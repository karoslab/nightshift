...
function validateJourneys(journeys, targetOrigin) {
...
function validate(config) {
  ...
  validateAuth(target.auth, new URL(target.url).origin);
  validateJourneys(target.journeys, new URL(target.url).origin);
